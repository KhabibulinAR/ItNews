    ...
    public class AccountController : Controller
    {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await UserManager.SendEmailAsync(user.Id, "Email verification",
                       "To complete the registration, click on the link: <a href=\""
                    ...
                    MainService.AuthorService.CreateAuthor(mapper.Map<Author, AuthorViewModel>(author));
        ...
        private void CreateAdminIfNeeded()
        {
            ...
            if (objAdminUser == null)
            {
                ...
                // Create Admin user
                var objNewAdminUser = new ApplicationUser { UserName = AdminUserName, Email = AdminEmail, EmailConfirmed = true };
